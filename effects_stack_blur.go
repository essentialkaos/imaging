...
// StackBlur produces a blurred version of the image using a StackBlur function.
//
// Stackblur is a compromise between Gaussian blur and Box blur, but it creates much
// better looking blurs than Box blur and it is ~7x faster than Gaussian blur.
//
// Example:
//
//	dstImage := imaging.StackBlur(srcImage, 10)
